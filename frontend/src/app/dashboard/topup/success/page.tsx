      ...
      >
        <div className="text-center">
          ...
          <p className="text-zinc-400 mb-6">
            Your topup has been processed successfully. Balance will be updated shortly.
          </p>
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="py-3 bg-green-600 text-white rounded-xl font-black hover:bg-green-700 transition-colors flex items-center justify-center gap-2"
            >
              <Home size={20} />
              Go to Dashboard
            </button>
